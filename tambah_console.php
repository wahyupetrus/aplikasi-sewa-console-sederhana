...
<div class="container" style="margin-top: 50px;">
    <h4 style="color:white;">Tambah Console</h4>
    <form action="simpan_console.php" method="post">
    <table class="table table-borderless">
        <tr>
            <td>Nama Console</td>
            <td><input name="nama_console" type="text" placeholder="Nama Console" class="form-control"></td>
        </tr>
        <tr>
            <td></td>
